...
import com.sgllnh.myblog.entity.Links;
import com.sgllnh.myblog.service.ILinksService;
 ...
 */
@RestController
@RequestMapping("generator/links")
public class LinksController {
    ...
    public R list(@ApiIgnore @RequestParam Map<String, Object> params) {
        ...
        List<Links> selectAll = linksService.list();
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "links", value = "links实体类", required = true, dataType = "Links")})
