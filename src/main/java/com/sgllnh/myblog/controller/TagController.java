...
import com.sgllnh.myblog.entity.Tag;
import com.sgllnh.myblog.service.ITagService;
...
public class TagController {
    ...
    public R list(@ApiIgnore @RequestParam Map<String, Object> params) {
        ...
        List<Tag> selectAll = tagService.list();
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "tag", value = "tag实体类", required = true, dataType = "Tag")})
