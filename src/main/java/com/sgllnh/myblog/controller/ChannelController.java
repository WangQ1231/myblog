...
import com.sgllnh.myblog.service.IChannelService;
...
public class ChannelController {
    ...
    public R list(@ApiIgnore @RequestParam Map<String, Object> params) {
        ...
        List<Channel> selectAll = channelService.list();
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "channel", value = "channel实体类", required = true, dataType = "Channel")})
